...
export function Result( { packages } ) {
    ...
    let geneticResults = genetic_algorithm(num_generations, pop_size, num_parents, num_offsprings, mutation_rate, packages.length, packages);
    
    // Exibindo a ordem otimizada dos pacotes
    console.log("Ordem otimizada dos pacotes:");
    console.log(geneticResults.optimized_df);
    
    let optimized_df = geneticResults.optimized_df;
